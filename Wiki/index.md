...
- **4 Documents (HMG 북미 프로젝트 구성)** — Zuora → SAP 연동 대상:
    - [[북미/Zuora/documents/Invoice|Invoice]] — 정상 청구 (AR ↑)
    - [[북미/Zuora/documents/Credit Memo|Credit Memo]] — 잔액 차감 (AR ↓, 장부)
    - [[북미/Zuora/documents/Payment|Payment]] — 결제 수령 (AR ↓, 현금 유입)
    - [[북미/Zuora/documents/Refund|Refund]] — 환불 (현금 유출) ⭐ 신규
- **참고**: [[북미/Zuora/documents/Debit Memo|Debit Memo]] — Zuora 공식 개념이지만 HMG 4 Documents에는 미포함
